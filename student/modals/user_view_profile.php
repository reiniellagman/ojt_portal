                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="form-group">
                                <label>Course</label>
                                <input type="text" class="form-control" value="<?php echo $course ?>" placeholder="Course" name="course" readonly/>
                            </div>
                            <div class="form-group">
                                <label>Institute</label>
                                <input type="text" class="form-control" value="<?php echo $institute ?>" placeholder="Institute" name="institute" readonly/>
                            </div>
                            <div class="form-group">
                                <label>School Year</label>
                                <input type="text" class="form-control" value="<?php echo $school_year ?>" placeholder="School Year" name="school_year" readonly/>
                            </div>
                            <div class="form-group">
                                <label>Adviser</label>
                                <input type="text" class="form-control" value="<?php echo $assigned_instructor ?>" placeholder="Adviser" name="adviser" readonly/>
                            </div>
                        </div>
                        <div class="col-sm-12">
                            <div class="form-group">
